...
field_specs={"C": {"stem":"C_tip_transverse","source_nm":[0.0,35.0],"geometry":"rod"},
             "D": {"stem":"D_sphere_R15.9","source_nm":[0.0,20.874],"geometry":"sphere"}}
for key,spec in field_specs.items():
    ...
    summary["cases"][key]["nearfield"]={"shape":[int(a.shape[0]),int(a.shape[1])],
        ...
        "source_position_nm":spec["source_nm"]}
...
for ax,(key,spec) in zip(axs,field_specs.items()):
    ...
    ax.set(title=CASES[key][1],xlabel="x (nm)",ylabel="z (nm)",aspect="equal")
