...
\author{امین حسین سدیدی\thanks{نویسنده‌ی مسئول.}%
  \and سید محمد پارسا مولایی طبری%
  \and مالک باقری هارونی\thanks{استاد راهنما.}\\[0.4em]
  \normalsize گروه فیزیک، دانشکده‌ی فیزیک، دانشگاه اصفهان، اصفهان، ایران}
\date{}
\maketitle
