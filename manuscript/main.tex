...
%  کوانتومی در مجاورت نانومیله پلاسمونی طلا با روش FDTD متقارن‌محوری
%  ---------------------------------------------------------------
...
انتهایی نیم‌کروی با استفاده از روش تفاضل محدود در حوزه زمان (axisymmetric FDTD)
...
$\lambda_{\text{res}} = \nm{592}$ به مقدار بیشینه
$\Fp \approx 1937$ می‌رسد که بیانگر افزایش بیش از سه مرتبه بزرگی در
نرخ واپاشی کل است. هم‌زمان، توان تابش‌شده به میدان دوردست نیز تقویتی
بالغ بر ۱۱۲ برابر ($T_{\text{max}} = 112.1$) را در طول‌موج
$\nm{600}$ با راندمان تابشی ظاهری $6.5\%$ به ثبت رسانده است.
