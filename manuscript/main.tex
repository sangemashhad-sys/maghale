...
$\nm{20}$) با روش سه‌بعدی تفاضل محدود در حوزه‌ی زمان (3D-FDTD) بررسی شد.
دوقطبی در فاصله‌ی $\nm{5}$ از نوک نانومیله قرار دارد. برای دوقطبی طولی،
قله‌ی فاکتور پورسل $\Fp \approx 1.5\times10^{3}$ نزدیک $\nm{610}$ و
بیشینه‌ی تقویت توان تابشی $T_{\max} \approx 1.2\times10^{2}$ نزدیک
$\nm{616}$ به دست آمد. چون این دو قله در یک طول‌موج نیستند، به‌جای تقسیم
مستقیم آن‌ها، برای طول‌موج قله‌ی پورسل کران $\eta_a \le 8\%$ به دست آمد که
غلبه‌ی اتلاف غیرتابشی را نشان می‌دهد. سه اجرای کنترل — فضای آزاد، دوقطبی
عرضی روی همان نوک، و کره‌ی طلای هم‌حجم — نشان دادند که در حوالی تشدید،
پاسخ طولی نانومیله ده‌ها برابر از پاسخ عرضی و از کره‌ی هم‌حجم قوی‌تر است.
اجرای کره با حل تحلیلی می برای دوقطبی شعاعی مقایسه شد و شکل طیفی و مکان
قله‌ها با اختلاف کمتر از $\nm{4}$ و ارتفاع قله‌ها با اختلاف $8$ تا
$15$ درصد بازتولید شدند؛ این اختلاف مقیاس عدم‌قطعیت عددی مش
$\nm{2}$ را تعیین می‌کند. این نتایج وابستگی نرخ کل و توان تابشی به
جهت‌گیری گسیل‌گر و شکل نانوساختار را مستقیماً نشان می‌دهند و لزوم گزارش
جداگانه‌ی کانال‌های تابشی و غیرتابشی در محیط ناهمسانگرد و اتلافی را
تأیید می‌کنند.
\end{abstract}
