...
\author{
نام دانشجو: \textbf{[نام و نام خانوادگی]} \\
شماره‌ی دانشجویی: \textbf{[شماره‌ی دانشجویی]} \\
درس: \textbf{[نام درس]} --- دانشکده‌ی فیزیک \\
استاد درس: \textbf{[نام استاد]} \\
دانشگاه: \textbf{[نام دانشگاه]} \\
نیم‌سال تحصیلی: \textbf{[نیم‌سال، مثلاً ۱۴۰۴--۱۴۰۵]}
}
\date{}
\maketitle
